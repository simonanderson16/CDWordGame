...
const Play = () => {
    ...
    const handleGuess = () => {
        if (game) {
            ...
            } else if ([...input].some((letter) => !game.availableLetters.includes(letter) && !(letter === game.requiredLetter))) {
                        ...
                        <DialogHeader>
                            <DialogDescription>
                                ...
                                {game?.credits.words && (
                                    <p className="text-sm">
                                        Words from{" "}
                                        <a className="linkedin-link text-primary" href={game?.credits.words} target="_blank">
                                            {game?.credits.words}
                                        </a>
                                    </p>
                                )}
                                <p className="text-sm">
                                    Site by{" "}
                                    <a className="linkedin-link text-primary" href="https://www.linkedin.com/in/simonanderson16/" target="_blank">
                                        Simon Anderson
                                    </a>
                                </p>
                            </DialogDescription>
            ...
            {game && playing ? (
                <div className="play-inner-container">
                    <div className="play-half-1">
                        ...
                        <div className="letters">
                            ...
                            {/* {game.availableLetters.slice(0, 5).map((letter, index) => (
                <div
                ...
                >
                  {letter}
                            ...
                            <div id="circle">
                                {game.availableLetters.slice(0, 4).map((item, index) => (
                                ...
                                <div id="wrapper6">
                                    <div className="item6 item">
                                        <div className="content">
                                            <a>{game.availableLetters[5]}</a>
                                        </div>
                                    </div>
                                </div>
                                <div id="center">
                                    <div className="content">
                                        <a href="#">{game.requiredLetter}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <>
                    {gameExists ? (
                        <>
                            <Button onClick={handlePlayGame} disabled={!game} className="play-button">
                                {loading ? (
